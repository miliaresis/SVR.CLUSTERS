...
# Table 1. 
The linear regression of the 2-d feature space indicate that these **PERFECT** ! ! !  ***particular*** relationships exist for all the clusters ! ! ! of this particular feature space (ALOS, SRTM, ASTER GDEMS) for the (pc2, pc3) reconstructed (residual) elevations in Zagros Ranges ! ! !  Notice also that **a + b = 1** ! ! !
